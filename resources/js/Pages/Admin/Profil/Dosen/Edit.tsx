...
export default function Edit({ lecturer }: { lecturer: Lecturer }) {
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(lecturer.photoUrl);
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.profil.dosen.update', lecturer.id), {
            forceFormData: true,
        });
    };
        ...
        <AdminLayout title="Edit Dosen">
            ...
            >
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-slate-800">Edit Dosen</h1>
                </div>
