                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="https://fasilkom.unsri.ac.id" target="_blank" className="hover:text-white">Fakultas Ilmu Komputer</a></li>
                            <li><a href="#" target="_blank" className="hover:text-white">Portal Akademik</a></li>
                            <li><a href="#" target="_blank" className="hover:text-white">Penerimaan Mahasiswa Baru</a></li>
                        </ul>
                    </div>
