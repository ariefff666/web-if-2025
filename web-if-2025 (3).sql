...
--
-- Indexes for table `akademik_dokumens`
--
ALTER TABLE `akademik_dokumens`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `struktur_pimpinans`
--
ALTER TABLE `struktur_pimpinans`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `akademik_dokumens`
--
ALTER TABLE `akademik_dokumens`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `c_p_l_s`
--
ALTER TABLE `c_p_l_s`
...
--
-- AUTO_INCREMENT for table `news_announcements_achievements`
--
ALTER TABLE `news_announcements_achievements`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `panduan_sops`
--
ALTER TABLE `panduan_sops`
...
--
-- AUTO_INCREMENT for table `struktur_pimpinans`
--
ALTER TABLE `struktur_pimpinans`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
